...
6. It adds selected lagged weather features, such as humidity and temperature from earlier weeks. These lags represent delayed dengue effects from weather conditions.

7. It adds rolling weather means over recent windows. These summarize recent exposure, for example average humidity or temperature over the last several weeks.

8. It builds separate feature sets for San Juan and Iquitos. San Juan uses broader delayed temperature and humidity signals, while Iquitos uses shorter humidity, temperature, NDVI, and precipitation signals.
